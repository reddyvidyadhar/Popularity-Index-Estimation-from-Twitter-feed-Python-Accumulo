...
import sys
import string
import json as simplejson #install simplejson at https://pypi.python.org/pypi/simplejson/
...
hashtag=["Celtics","Knicks","76ers","Nets","Raptors","Bulls","Pacers","Bucks","Pistons","Cavs","MiamiHeat","OrlandoMagic","Hawks","Bobcats","Wizards","okcthunder","Nuggets","TrailBlazers","UtahJazz","TWolves","Lakers","Suns","GSWarriors","Clippers","NBAKings","GoSpursGo","Mavs","Hornets","Grizzlies","Rockets"]
#hashtag = 'Rockets' ##### this line need to change
for i in range(0,30):
    delimiter = ','
    data = t.search(q='#'+hashtag[i], count=100)
